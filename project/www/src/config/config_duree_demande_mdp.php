...
// validite pour le changement du mot passe
...
define('CHMDP_D', '1'); // Duree de validite pour le changement du mot de passe en jour.
define('CHMDP_H', '0'); // Duree de validite pour le changement du mot de passe en heure.
